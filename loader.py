...
def load_caltech256(batch_size, valid_size=0.1, path="/datasets/Caltech256/256_ObjectCategories/"):
    # Define transofrm
    ...
    # Load dataset
    test_dataset = Caltech256("/datasets/Caltech256/256_ObjectCategories/", transform, train=False)
    train_dataset = Caltech256("/datasets/Caltech256/256_ObjectCategories/", transform, train=True)
    ...
    num_workers = 1
    pin_memory = True
    # Split training set into validation set / training set
    train_idx, valid_idx = indices[split:], indices[:split]
    train_sampler = SubsetRandomSampler(train_idx)
    valid_sampler = SubsetRandomSampler(valid_idx)
    ...
    validationloader = torch.utils.data.DataLoader(train_dataset, 
                    batch_size=batch_size, sampler=valid_sampler, 
                    num_workers=num_workers, pin_memory=pin_memory)
